...
$routes->post('update_data', 'dashboard::updatedata');
$routes->post('update_stugas', 'dashboard::update_stugas');
$routes->post('update_skeluar', 'dashboard::update_skeluar');
$routes->post('update_nota', 'dashboard::update_nota');
